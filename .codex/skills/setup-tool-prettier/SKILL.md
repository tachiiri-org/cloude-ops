---
name: setup-tool-prettier
description: Ensure Prettier configuration and format scripts are configured for repositories that use Prettier.
---
...
- Use `/home/tachiiri/.guide/tools.md` as the authority for Prettier adoption and version selection.
...
3. Read `/home/tachiiri/.guide/tools.md` for the Prettier baseline when reconciling package versions
4. Ensure the repository includes the Prettier version selected in `/home/tachiiri/.guide/tools.md`
