...
- Use `/home/tachiiri/.guide/tools.md` as the authority for Vitest adoption and version selection.
...
3. Read `/home/tachiiri/.guide/tools.md` for the Vitest baseline when reconciling package versions
4. Ensure the repository includes the Vitest version selected in `/home/tachiiri/.guide/tools.md`
