---
name: setup-tool-pyright
description: Ensure Pyright configuration and typecheck scripts are configured for Python repositories.
---
...
- Reconcile to the `tools/pyright.md` baseline during ordinary setup
